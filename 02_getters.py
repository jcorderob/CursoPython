...
def main():
    ...
    print("\n--------- Vaca ----------")
    print(vaca.get_datos_privados())     # Getter que devuelve los datos privados de instancia
    print("\n-------- Gato -----------")
    print(gato.get_datos_privados())     # Getter que devuelve los datos privados de instancia
